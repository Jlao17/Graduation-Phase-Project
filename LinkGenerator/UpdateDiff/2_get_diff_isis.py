...
repo_path = "https://github.com/apache/causeway"  # Change to your repo path or  local directory

df = pd.read_csv("../../data/ProcessedIsis/1.5_isis_process_notes_cleaned.csv")
...
df = df[['issue_id', 'summary_processed', 'description_processed', 'issuecode', 'hash', 'fix_version', 'tracking_id',
 ...
 'target']]
df.to_csv("../../data/ProcessedIsis/2_isis_link_merged.csv", index=False)
