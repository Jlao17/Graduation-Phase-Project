...
repo_path = "https://github.com/apache/netbeans"  # Change to your repo path or  local directory

df = pd.read_csv("../../data/ProcessedNetbeans/1.5_netbeans_process_notes_cleaned.csv")
...
df = df[['issue_id', 'summary_processed', 'description_processed', 'issuecode', 'hash', 'fix_version', 'tracking_id',
 ...
 'target']]
df.to_csv("../../data/ProcessedNetbeans/2_netbeans_link_merged.csv", index=False)
